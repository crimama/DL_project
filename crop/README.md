...
- Ver4 : Random Preprocess 추가 
   ...
   - 결과 : LB 0.9007으로 미약하게나마 상승 <-----**이걸로 추후 진행** (rotate augmentation 미적용 된것임)
...
- Ver 5 : Image Padding 
  ...
  - 파일: [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/crimama/DL_project/blob/main/crop/Version_files/22_01_24_Ver5_작물병해_image_padding.ipynb)
